...
!function (t, e) {
    ...
    return function (t) {
        ...
        (function (e) {
            ...
            a(i, s), i.prototype.supportsBinary = !1, i.prototype.doClose = function () {
                ...
                if (!this.form) {
                    ...
                    s.className = "socket.io", s.style.position = "absolute", s.style.top = "-1000px", s.style.left = "-1000px", s.target = c, s.method = "POST", s.setAttribute("accept-charset", "utf-8"), a.name = "d", s.appendChild(a), document.body.appendChild(s), this.form = s, this.area = a
                }
        ...
        var o = n(7), i = n(11), s = n(40), a = n(41), c = n(42), u = n(3)("socket.io-client:socket"), p = n(32),
            h = n(26);
        t.exports = e = r;
        var f = {
            connect: 1,
